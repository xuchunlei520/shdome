...
当前生产版本为 `v0.1.7`，生产入口为 `https://k.flowread.cc`。以下版本号用于说明当前已验证流程；发布下一版本时应整体替换为新的 `vX.Y.Z`。
...
| 发布 Commit | `5dd561c0e0c215f196c0718a0ca99e9f6ae9452e` |
| 归档 SHA-256 | `8c5253b9c6f6a782d988fa4669e663f79acc5e53d87380882d43c7cc02138533` |
...
```bash
bash scripts/build-release.sh v0.1.7
```
...
```text
dist/shdome-v0.1.7.tar.gz
dist/shdome-v0.1.7.tar.gz.sha256
```
...
- `SHDOME_RELEASE_VERSION`：例如 `v0.1.7`。
...
```bash
curl -fsSL https://k.flowread.cc | grep 'v0.1.7'
