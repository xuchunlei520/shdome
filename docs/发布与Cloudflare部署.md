...
当前生产版本为 `v0.2.0`，生产入口为 `https://k.flowread.cc`。以下版本号用于说明当前已验证流程；发布下一版本时应整体替换为新的 `vX.Y.Z`。
...
| 发布 Commit | `12c441b18365daa992a401f906b324b38dbb1252` |
| 归档 SHA-256 | `6a5a87cf6353e4dbc7d20b4cb9fa6758db5e41e529ef6bf8f1e3043a22cf6fb7` |
...
```text
dist/shdome-v0.2.0.tar.gz
dist/shdome-v0.2.0.tar.gz.sha256
```
...
- `SHDOME_RELEASE_VERSION`：例如 `v0.2.0`。
...
```bash
curl -fsSL https://k.flowread.cc | grep 'v0.2.0'
