...
当前生产版本为 `v0.1.6`，生产入口为 `https://k.flowread.cc`。以下版本号用于说明当前已验证流程；发布下一版本时应整体替换为新的 `vX.Y.Z`。
...
| 发布 Commit | `7258b07a66c7d5dbd5b1edea28dda9a68abecb94` |
| 归档 SHA-256 | `1903eb1f94530de8a8c4dec4199dbb0a6d59645cb31b5284d759935124d723e7` |
...
```bash
bash scripts/build-release.sh v0.1.6
```
...
```text
dist/shdome-v0.1.6.tar.gz
dist/shdome-v0.1.6.tar.gz.sha256
```
...
- `SHDOME_RELEASE_VERSION`：例如 `v0.1.6`。
...
```bash
curl -fsSL https://k.flowread.cc | grep 'v0.1.6'
